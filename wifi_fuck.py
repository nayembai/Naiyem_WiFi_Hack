#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Modify History : rofl0r => Biri_B@B@ => Muhammad_Naiyem(Toxinum)
# VERSION 1.0.1
...
#            print("[!] Unexpected interference — kill NetworkManager/wpa_supplicant!")
    ...
    def __credentialPrint(self, wps_pin=None, wpa_psk=None, essid=None):
        ...
        print(f"[\033[1;32m+\033[1;37m] WiFi PASS :- '{wpa_psk}'")
  ...
  \ \ /\ / /| | |_  | |_____| |_| | / _ \| |   | ' /  
   \ V  V / | |  _| | |_____|  _  |/ ___ \ |___| . \  
    \_/\_/  |_|_|   |_|     |_| |_/_/   \_\____|_|\_\ 
                                                  \n\t\t[\033[1;32m*\033[1;37m] Modified by : Naiyem \n\t\t[\033[1;32m*\033[1;37m] Version     : Paid \n\t\t[\033[1;32m*\033[1;37m] Telegram    : @Muhammad_Naiyem \n''')
